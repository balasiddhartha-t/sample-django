    ...
    stages {
        ...
        stage('Deploy the code into Server'){
            steps{
                  ...
                  sh "docker run --name dummyserver -e DJANGO_ALLOWED_HOSTS='127.0.0.1,34.233.121.252,0.0.0.0' -e DATABASE_URL='postgres://postgres:mysecretpassword@34.233.121.252:5432/postgres_db' -d -p 8089:8000 dummyimage:latest"
             }
